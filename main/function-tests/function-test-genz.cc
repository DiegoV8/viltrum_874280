...
int main(int argc, char* argv[]) {
    ...
    case 2:
        // Debido a la concurrencia es más difícil leer los logs del multiqueue
        run_test_logs<GenzContinuous<Dim>, Dim>("Continuous", GenzContinuous<Dim>(a, u), 32, csv_file, run_name);
        break;
